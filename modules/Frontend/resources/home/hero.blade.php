                ...
                <div class="col-12">
                    <div class="hero-inner">
                        ...
                        <div class="welcome-text">
                            <h1 class="h1">@lang('frontend.find_your_dream')
                            <br class="d-md-none">
                        ...
                        <div class="col-12">
                            <div class="banner-search-wrap">
                                <ul class="nav nav-tabs rld-banner-tab">
                                    <li class="nav-item">
                                        <a class="nav-link active" data-toggle="tab" href="#tabs_1">@lang('frontend.for_sale')</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" data-toggle="tab" href="#tabs_2">@lang('frontend.for_rent')</a>
                                    </li>
                                </ul>
