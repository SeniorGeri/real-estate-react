                ...
                <div className="grid auto-rows-min gap-4 md:grid-cols-4">
                    ...
                    <div className="border-sidebar-border/70 dark:border-sidebar-border relative aspect-video overflow-hidden rounded-xl border">
                        <div className="flex h-full items-center justify-around gap-4">
                            ...
                            <div className="flex flex-col gap-2">
                                ...
                                <p className="text-center text-sm">{t('total_finished')}: {activeCourses.total_finished}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="border-sidebar-border/70 dark:border-sidebar-border relative aspect-video overflow-hidden rounded-xl border">
                        <div className="flex h-full items-center justify-around gap-4">
                            <GraduationCap className="h-20 w-20" />
                            <div className="flex flex-col">
                                <p className="text-center text-lg font-semibold">{t('total_rejected')}</p>
                                <p className="text-center text-sm">{t('total_rejected')}: {activeCourses.total_rejected}</p>
                            </div>
                        </div>
                    </div>
                </div>
